...
// As you can see this doesn't use tailwinf but there is package
// @react-email/tailwind
// https://www.npmjs.com/package/@react-email/tailwind
// I will use @react-email/tailwind this im next projects
// but here since this is copied snippped I'm not going to use it to save time
...
export const CelebrationTemplate = ({
  ...
  return (
    // biome-ignore lint/a11y/useHtmlLang: This is email no need for lang tag on html (I assume)
    <html>
      <body
        style={{
